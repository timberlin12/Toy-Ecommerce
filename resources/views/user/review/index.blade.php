            ...
            <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-{{ $review->status == 'active' ? 'success' : 'warning' }}">
                                {{ $review->status }}
                            </span>
                        </td>
                        <td>
                            <a href="{{ route('user.productreview.edit', $review->id) }}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px;width:30px;border-radius:50%" data-toggle="tooltip" title="Edit">
...
<script>
    $('#order-dataTable').DataTable({
        "columnDefs": [
            { "orderable": false, "targets": [4, 6, 7] } // Disable sorting on Rating, Status, Action
        ]
    });
